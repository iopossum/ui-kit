...
export const TABLET_LANDSCAPE_MAX_WIDTH = process.env.TABLET_LANDSCAPE_MAX_WIDTH
  ? parseInt(process.env.TABLET_LANDSCAPE_MAX_WIDTH, 10)
  : 899;
export const TABLET_MAX_WIDTH = process.env.TABLET_MAX_WIDTH ? parseInt(process.env.TABLET_MAX_WIDTH, 10) : 1239;
export const DESKTOP_LARGE_WIDTH = process.env.DESKTOP_LARGE_MAX_WIDTH
  ? parseInt(process.env.DESKTOP_LARGE_MAX_WIDTH, 10)
  : 1599;
